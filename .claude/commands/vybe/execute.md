...
if [ "$guidance_mode" = false ]; then
    ...
    echo "=============================================="
    echo "AI MUST read and apply technology registry files:"
    echo ""
    echo "🔍 MANDATORY READING:"
    echo "- .vybe/tech/languages.yml - Extract actual commands for $LANGUAGE_NAME"
    echo "- .vybe/tech/frameworks.yml - Framework-specific patterns"
    echo "- .vybe/tech/testing.yml - Testing approach and tools"
    echo "- .vybe/tech/build.yml - Build and bundling approach"
    echo "- .vybe/tech/tools.yml - Development utilities"
    echo ""
    echo "🎯 CRITICAL: Extract commands from languages.yml:"
    echo "- Package manager tool name (currently: $PACKAGE_TOOL)"
    echo "- Installation commands (currently: $PACKAGE_INSTALL)"
    echo "- Add package commands (currently: $PACKAGE_ADD)"
    echo "- Execution commands (currently: $LANGUAGE_RUNNER)"
    echo ""
    echo "❌ DO NOT use generic commands like 'python', 'pip', 'npm'"
    echo "✅ DO use project-specific commands from technology registry"
    echo ""
    ...
    echo "[CRITICAL] 🔧 USE DETECTED TECHNOLOGY STACK"
    echo "=========================================="
    echo ""
    echo "AI MUST use the detected technology stack:"
    echo "  Language: $LANGUAGE_NAME"
    echo "  Runner: $LANGUAGE_RUNNER"
    echo "  Package Tool: $PACKAGE_TOOL"
    echo "  Install Command: $PACKAGE_INSTALL"
    echo "  Add Package: $PACKAGE_ADD"
    echo "  Test Runner: $TEST_RUNNER"
    echo "  Build Command: $BUILD_COMMAND"
    echo "  Server Runner: $SERVER_RUNNER"
    ...
    echo "  Use $PACKAGE_TOOL instead of pip/npm/cargo"
    echo "  Use $LANGUAGE_RUNNER instead of python/node/go"
    echo "  Use $PACKAGE_INSTALL for dependency installation"
    echo "  Use $PACKAGE_ADD for adding new packages"
    echo ""
    echo "🚫 FORBIDDEN: Using hardcoded commands like 'python', 'pip', 'npm'"
    echo "✅ REQUIRED: Using detected commands like '$LANGUAGE_RUNNER', '$PACKAGE_TOOL'"
    echo ""
    echo "EXAMPLES:"
    echo "  ❌ BAD: python app.py"
    echo "  ✅ GOOD: $LANGUAGE_RUNNER app.py"
    echo ""
    echo "  ❌ BAD: pip install requests"
    echo "  ✅ GOOD: $PACKAGE_ADD requests"
    echo ""
    echo "  ❌ BAD: pip install -r requirements.txt"
    echo "  ✅ GOOD: $PACKAGE_INSTALL"
    echo ""
    echo "AI MUST apply these commands in ALL generated files:"
    echo "- Demo scripts"
    ...
    echo "- USE detected technology stack variables consistently"
    echo ""
