...
### Spec Files
- Spec directory: !`ls -la .vybe/specs/$ARGUMENTS/`
...
- Tasks: @.vybe/specs/$ARGUMENTS/tasks.md

### All Specs Overview
- Available specs: !`ls -la .vybe/specs/`
- Active specs: !`find .vybe/specs/ -name "spec.json" -exec grep -l "implementation_ready.*true" {} \;`

## Task: Generate Status Report

Create comprehensive status report for the specification in the language specified in spec.json (check `@.vybe/specs/$ARGUMENTS/spec.json` for "language" field):
