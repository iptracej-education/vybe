...
### Steering Context
- Architecture context: @.vybe/steering/structure.md
- Technical constraints: @.vybe/steering/tech.md
- Product context: @.vybe/steering/product.md
- Custom steering: Load all "Always" mode custom steering files from .vybe/steering/

### Existing Spec Context
- Current spec directory: !`ls -la .vybe/specs/$ARGUMENTS/`
- Current requirements: @.vybe/specs/$ARGUMENTS/requirements.md
...
Generate requirements.md in the language specified in spec.json (check `@.vybe/specs/$ARGUMENTS/spec.json` for "language" field):
...
Run `/vybe:spec-design $ARGUMENTS -y` to proceed to design phase
